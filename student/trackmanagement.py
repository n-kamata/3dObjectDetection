...
class Track:
    ...
    def __init__(self, meas, id):
        ...
        sigma_p44 = params.sigma_p44 # vx
        sigma_p55 = params.sigma_p55 # vy
        sigma_p66 = params.sigma_p66 # vz
...
class Trackmanagement:
    ...
    def handle_updated_track(self, track):      
        ...
        track.score += 1
        track.score = min(track.score, params.window)
        if track.score/params.window >= params.delete_threshold:
            track.state = 'tentative'
        if track.score/params.window >= params.confirmed_threshold:
